...
def sessions_started_per_day(request):
    if request.user.is_authenticated():
        ...
        return render_to_response('session_stats/sessions_started_per_day.html', {'all_dates': all_dates}, context_instance=RequestContext(request))
    else:
        return render_to_response('showlog.html', {}, context_instance = RequestContext(request))
...
def unique_user_sesh(request):
    if request.user.is_authenticated():
        ...
        return render_to_response('session_stats/unique_user_sesh.html', {'all_dates': all_dates}, context_instance=RequestContext(request))
    else:
        return render_to_response('showlog.html', {}, context_instance = RequestContext(request))
